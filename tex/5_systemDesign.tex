...
Figure~\ref{fig:fabric-docker} shows the development network of Hyperledger Fabric running inside Docker containers. The setup includes:
\vspace{-0.5em}
\begin{itemize}[leftmargin=1.5em]
...
\begin{lstlisting}[language=JavaScript,caption={EvidenceContract chaincode for storing and retrieving evidence metadata}]
'use strict';
...
\begin{lstlisting}[language=JavaScript,caption={Backend submission controller for interacting with Hyperledger Fabric}]
