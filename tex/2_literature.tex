...
\vspace{0.15in}
\noindent
Practical implementations explore combinations of blockchain with IPFS or cloud backends and evaluate encryption strategies and revocation mechanisms. For example, attribute‑based encryption integrated with smart contracts supports fine‑grained access and fast revocation in cloud file sharing scenarios \cite{abe_cloud_2023}, while serverless and cost‑efficient designs examine tradeoffs between confidentiality, latency, and operational cost \cite{decentralized_cloud_2024, healthcare_framework_2024}.
